// moments/components/landing/Footer.tsx
  ...
  return (
    <footer className="bg-white border-t border-border py-12">
      <div className="container mx-auto px-4">
        {/* Updated grid for better responsiveness and alignment */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Create beautiful collaborative memory books for life&apos;s
              special moments.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* Removed Pricing */}
              {/* Link to new Features page as Examples (per previous discussion) */}
              <li>
                <a
                  href="/features"
                  className="text-sm text-muted-foreground hover:text-primary"
          ...
          <div>
            ...
            <ul className="space-y-2">
              {/* Changed to absolute links starting with /# to force navigation back to home page */}
              <li>
                <a
                  href="/#"
                  className="text-sm text-muted-foreground hover:text-primary"
        ...
        <div className="border-t border-border mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            {/* Changed to absolute links starting with /# */}

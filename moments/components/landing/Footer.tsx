            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {/* Merged links, assuming /features is the new destination for features/examples */}
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {/* Merged links, using /about and new /blog, /faqs routes */}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {/* Standardized support links to /# for placeholders */}
                ...
                <div className="border-t border-border mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        {/* Social Media Links - Standardized to /# for placeholders */}
